...
![查看版本](https://cdn.jsdelivr.net/gh/CNplus/CNplus-wiki@main/images/quickstart/01-version.png)
...
- 第二行会把 CNplus 下载到你桌面的 `CNplus-lang` 文件夹，看到一堆 `Receiving objects...` 就说明在下载：

![下载 CNplus](https://cdn.jsdelivr.net/gh/CNplus/CNplus-wiki@main/images/quickstart/02-clone.png)

- 第四行是安装，最后一行出现 **`Successfully installed cnplus-0.8.0`** 就装好了：

![安装完成](https://cdn.jsdelivr.net/gh/CNplus/CNplus-wiki@main/images/quickstart/03-install.png)
...
![跑通示例](https://cdn.jsdelivr.net/gh/CNplus/CNplus-wiki@main/images/quickstart/04-run.png)
...
装好后，扩展面板的「已安装」里能看到 CNplus：

![扩展面板里的 CNplus](https://cdn.jsdelivr.net/gh/CNplus/CNplus-wiki@main/images/quickstart/05-extension.png)
...
![按 F5 运行，终端输出「你好，小明」](https://cdn.jsdelivr.net/gh/CNplus/CNplus-wiki@main/images/quickstart/07-run.png)
